        ...
        <form action="{{ route('order.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input required type="radio" class="form-check-input" name="methodPayment" value="money">
                        Dinheiro
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input required type="radio" class="form-check-input" name="methodPayment" value="card">
                        Cartão
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input required type="radio" class="form-check-input" name="methodPayment" value="bankSlip">
                        Boleto Bancario
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input required type="radio" class="form-check-input" name="methodPayment" value="pix">
                        Pix
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                @foreach ($prods as $prod)
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="product_id[]" rel="{{ $prod->price }}" value="{{ $prod->id }}"> {{ $prod->name }}
                        </label>
                    </div>
                @endforeach
            </div>
            ...
            <div class="form-row form-group">
                ...
                <div class="col-2 amountParcels">
                    ...
                    <input type="number" name="amountParcels" id="amountParcelsInput" class="form-control" placeholder="número de parcelas" aria-describedby="número de parcelas">
                </div>
                <div class="col-2 amountParcels">
